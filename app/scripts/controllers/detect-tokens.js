...
class DetectTokensController {
  ...
  async detectNewTokens () {
    ...
    this.wan3.setProvider(this._network._provider)
  ...
  async detectTokenBalance (contractAddress) {
    const ethContract = this.wan3.eth.contract(ERC20_ABI).at(contractAddress)
  ...
  set network (network) {
    ...
    this.wan3 = new Wan3(network._provider)
  }
